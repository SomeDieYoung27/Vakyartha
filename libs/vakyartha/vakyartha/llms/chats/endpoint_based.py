...
class EndpointChatLLM(ChatLLM):
    ...
    def run(
            self,
            messages : str | BaseMessage | list[BaseMessage],**kwargs
    ) -> LLMInterface:
        """
    ...
    def invoke(self,messages : str | BaseMessage | list[BaseMessage], **kwargs) -> LLMInterface:
        """Same as run"""
