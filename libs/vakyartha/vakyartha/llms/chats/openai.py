...
from vakyartha.base import  AIMessage, BaseMessage, HumanMessage, LLMInterface, Param
...
class BaseChatOpenAI(ChatLLM):
    ...
    def prepare_output(self,resp : dict) -> LLMInterface:
        ...
        if resp["choices"][0].get("logprobs") is not None:
            logprobs = []
    ...
    def invoke(
            self,
            messages : str | BaseMessage | list[BaseMessage],*args,**kwargs
    ) -> LLMInterface:
